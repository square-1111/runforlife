...
Only when Rules 1–3 do NOT fire (recovery is GREEN and load is in the safe 0.8–1.3 ACWR band):
...
> honored **only** from a recovered, safe-load base — never by overriding Rules 1–3.
